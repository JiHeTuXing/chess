...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UiHelp_t, stringdata) + ofs \
...
const QMetaObject UiHelp::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UiHelp.data,
      qt_meta_data_UiHelp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UiHelp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UiHelp.stringdata))
        return static_cast<void*>(const_cast< UiHelp*>(this));
